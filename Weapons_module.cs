...
public class Weapons_Module : MonoBehaviour{
    ...
    public class Weapon
    {
        ...
        public void Shoot(Mob selfDamageReceiver)
        {
            ...
            GameObject Bullet = Instantiate(bulletPrefab, bulletSourceTransform.position, new Quaternion(bulletSourceTransform.rotation.x, bulletSourceTransform.rotation.y, Random.Range(0, 360), 1));
